...
import com.dreamreco.joodiary.databinding.ActivityScreenLockBinding
import com.dreamreco.joodiary.util.KEY_NAME
import com.dreamreco.joodiary.util.LOGIN_CLEAR
import com.dreamreco.joodiary.util.LOGIN_NOT_CONFIRM
import com.dreamreco.joodiary.util.LOGIN_STATE
...
class ScreenLockActivity : AppCompatActivity() {
    private val binding by lazy { ActivityScreenLockBinding.inflate(layoutInflater) }
        ...
        biometricPrompt = BiometricPrompt(this, executor,
            object : BiometricPrompt.AuthenticationCallback() {
                ...
                override fun onAuthenticationSucceeded(
                    ...
                    val intent = Intent(this@ScreenLockActivity, MainActivity::class.java)
